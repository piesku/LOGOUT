(function(){"use strict";function e(e){return"#"===e.charAt(0)&&(e=e.substr(1)),3===e.length&&(e=e.split("").map((e)=>e+e).join("")),e.match(/.{1,2}/g).map((e)=>parseFloat((parseInt(e,16)/255).toFixed(2)))}function t(e){return e.reduce((e,t)=>{let o=(~~(255*t)).toString(16);return 1===o.length&&(o="0"+o),e+o},"#")}function o(e,t,o){let n,r,i;if(0==t)n=r=i=o;else{function a(e,o,n){return 0>n&&(n+=1),1<n&&(n-=1),n<1/6?e+6*(o-e)*n:n<1/2?o:n<2/3?e+6*((o-e)*(2/3-n)):e}let s=0.5>o?o*(1+t):o+t-o*t,c=2*o-s;n=a(c,s,e+1/3),r=a(c,s,e),i=a(c,s,e-1/3)}return[n,r,i]}function n(){let e=new De(3);return De!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e}function r(e,t,o){let n=new De(3);return n[0]=e,n[1]=t,n[2]=o,n}function i(e,t,o){return e[0]=t[0]+o[0],e[1]=t[1]+o[1],e[2]=t[2]+o[2],e}function a(e,t,o){return e[0]=t[0]-o[0],e[1]=t[1]-o[1],e[2]=t[2]-o[2],e}function s(e,t,o){return e[0]=t[0]*o,e[1]=t[1]*o,e[2]=t[2]*o,e}function c(e,t){let o=t[0]-e[0],n=t[1]-e[1],r=t[2]-e[2];return he(o*o+n*n+r*r)}function m(e,t){let o=t[0],n=t[1],r=t[2],i=o*o+n*n+r*r;return 0<i&&(i=1/he(i),e[0]=t[0]*i,e[1]=t[1]*i,e[2]=t[2]*i),e}function l(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function d(e,t,o){let n=t[0],r=t[1],i=t[2],a=o[0],s=o[1],c=o[2];return e[0]=r*c-i*s,e[1]=i*a-n*c,e[2]=n*s-r*a,e}function _(e,t,o){let n=t[0],r=t[1],i=t[2],a=o[3]*n+o[7]*r+o[11]*i+o[15];return a=a||1,e[0]=(o[0]*n+o[4]*r+o[8]*i+o[12])/a,e[1]=(o[1]*n+o[5]*r+o[9]*i+o[13])/a,e[2]=(o[2]*n+o[6]*r+o[10]*i+o[14])/a,e}function f(e,t){let o=r(e[0],e[1],e[2]),n=r(t[0],t[1],t[2]);m(o,o),m(n,n);let i=l(o,n);return 1<i?0:-1>i?ve:ye(i)}function p(){let e=new De(16);return De!=Float32Array&&(e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[11]=0,e[12]=0,e[13]=0,e[14]=0),e[0]=1,e[5]=1,e[10]=1,e[15]=1,e}function u(e){let t=new De(16);return t[0]=e[0],t[1]=e[1],t[2]=e[2],t[3]=e[3],t[4]=e[4],t[5]=e[5],t[6]=e[6],t[7]=e[7],t[8]=e[8],t[9]=e[9],t[10]=e[10],t[11]=e[11],t[12]=e[12],t[13]=e[13],t[14]=e[14],t[15]=e[15],t}function g(e){return e[0]=1,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=1,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=1,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function y(e,t){let o=t[0],n=t[1],r=t[2],i=t[3],a=t[4],s=t[5],c=t[6],m=t[7],l=t[8],d=t[9],_=t[10],f=t[11],p=t[12],u=t[13],g=t[14],y=t[15],v=o*s-n*a,h=o*c-r*a,E=o*m-i*a,x=n*c-r*s,b=n*m-i*s,A=r*m-i*c,R=l*u-d*p,S=l*g-_*p,k=l*y-f*p,F=d*g-_*u,L=d*y-f*u,T=_*y-f*g,O=v*T-h*L+E*F+x*k-b*S+A*R;return O?(O=1/O,e[0]=(s*T-c*L+m*F)*O,e[1]=(r*L-n*T-i*F)*O,e[2]=(u*A-g*b+y*x)*O,e[3]=(_*b-d*A-f*x)*O,e[4]=(c*k-a*T-m*S)*O,e[5]=(o*T-r*k+i*S)*O,e[6]=(g*E-p*A-y*h)*O,e[7]=(l*A-_*E+f*h)*O,e[8]=(a*L-s*k+m*R)*O,e[9]=(n*k-o*L-i*R)*O,e[10]=(p*b-u*E+y*v)*O,e[11]=(d*E-l*b-f*v)*O,e[12]=(s*S-a*F-c*R)*O,e[13]=(o*F-n*S+r*R)*O,e[14]=(u*h-p*x-g*v)*O,e[15]=(l*x-d*h+_*v)*O,e):null}function v(e,t,o){let n=t[0],r=t[1],i=t[2],a=t[3],s=t[4],c=t[5],m=t[6],l=t[7],d=t[8],_=t[9],f=t[10],p=t[11],u=t[12],g=t[13],y=t[14],v=t[15],h=o[0],E=o[1],x=o[2],b=o[3];return e[0]=h*n+E*s+x*d+b*u,e[1]=h*r+E*c+x*_+b*g,e[2]=h*i+E*m+x*f+b*y,e[3]=h*a+E*l+x*p+b*v,h=o[4],E=o[5],x=o[6],b=o[7],e[4]=h*n+E*s+x*d+b*u,e[5]=h*r+E*c+x*_+b*g,e[6]=h*i+E*m+x*f+b*y,e[7]=h*a+E*l+x*p+b*v,h=o[8],E=o[9],x=o[10],b=o[11],e[8]=h*n+E*s+x*d+b*u,e[9]=h*r+E*c+x*_+b*g,e[10]=h*i+E*m+x*f+b*y,e[11]=h*a+E*l+x*p+b*v,h=o[12],E=o[13],x=o[14],b=o[15],e[12]=h*n+E*s+x*d+b*u,e[13]=h*r+E*c+x*_+b*g,e[14]=h*i+E*m+x*f+b*y,e[15]=h*a+E*l+x*p+b*v,e}function h(e,t,o,n){let r=t[0],i=t[1],a=t[2],s=t[3],c=r+r,m=i+i,l=a+a,d=r*c,_=r*m,f=r*l,p=i*m,u=i*l,g=a*l,y=s*c,v=s*m,h=s*l,E=n[0],x=n[1],b=n[2];return e[0]=(1-(p+g))*E,e[1]=(_+h)*E,e[2]=(f-v)*E,e[3]=0,e[4]=(_-h)*x,e[5]=(1-(d+g))*x,e[6]=(u+y)*x,e[7]=0,e[8]=(f+v)*b,e[9]=(u-y)*b,e[10]=(1-(d+p))*b,e[11]=0,e[12]=o[0],e[13]=o[1],e[14]=o[2],e[15]=1,e}function E(e,t,o,n,r){let i,a=1/Math.tan(t/2);return e[0]=a/o,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=a,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[11]=-1,e[12]=0,e[13]=0,e[15]=0,null!=r&&r!==Infinity?(i=1/(n-r),e[10]=(r+n)*i,e[14]=2*r*n*i):(e[10]=-1,e[14]=-2*n),e}function x(e,t,o,n,r,i,a){let s=1/(t-o),c=1/(n-r),m=1/(i-a);return e[0]=-2*s,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=-2*c,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=2*m,e[11]=0,e[12]=(t+o)*s,e[13]=(r+n)*c,e[14]=(a+i)*m,e[15]=1,e}function b(e,t,o,n){let r,i,a,s,c,m,l,d,_,f,p=t[0],u=t[1],y=t[2],v=n[0],h=n[1],E=n[2],x=o[0],b=o[1],A=o[2];return ue(p-x)<Me&&ue(u-b)<Me&&ue(y-A)<Me?g(e):(l=p-x,d=u-b,_=y-A,f=1/he(l*l+d*d+_*_),l*=f,d*=f,_*=f,r=h*_-E*d,i=E*l-v*_,a=v*d-h*l,f=he(r*r+i*i+a*a),f?(f=1/f,r*=f,i*=f,a*=f):(r=0,i=0,a=0),s=d*a-_*i,c=_*r-l*a,m=l*i-d*r,f=he(s*s+c*c+m*m),f?(f=1/f,s*=f,c*=f,m*=f):(s=0,c=0,m=0),e[0]=r,e[1]=s,e[2]=l,e[3]=0,e[4]=i,e[5]=c,e[6]=d,e[7]=0,e[8]=a,e[9]=m,e[10]=_,e[11]=0,e[12]=-(r*p+i*u+a*y),e[13]=-(s*p+c*u+m*y),e[14]=-(l*p+d*u+_*y),e[15]=1,e)}function A(){let e=new De(9);return De!=Float32Array&&(e[1]=0,e[2]=0,e[3]=0,e[5]=0,e[6]=0,e[7]=0),e[0]=1,e[4]=1,e[8]=1,e}function R(){let e=new De(4);return De!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0,e[3]=0),e}function S(){let e=new De(4);return De!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e[3]=1,e}function k(e,t,o){o*=0.5;let n=pe(o);return e[0]=n*t[0],e[1]=n*t[1],e[2]=n*t[2],e[3]=fe(o),e}function F(e,t,o){let n=t[0],r=t[1],i=t[2],a=t[3],s=o[0],c=o[1],m=o[2],l=o[3];return e[0]=n*l+a*s+r*m-i*c,e[1]=r*l+a*c+i*s-n*m,e[2]=i*l+a*m+n*c-r*s,e[3]=a*l-n*s-r*c-i*m,e}function L(e,o,n,r){let t,i,a,s,c,m=o[0],l=o[1],d=o[2],_=o[3],f=n[0],p=n[1],u=n[2],g=n[3];return i=m*f+l*p+d*u+_*g,0>i&&(i=-i,f=-f,p=-p,u=-u,g=-g),1-i>Me?(t=ye(i),a=pe(t),s=pe((1-r)*t)/a,c=pe(r*t)/a):(s=1-r,c=r),e[0]=s*m+c*f,e[1]=s*l+c*p,e[2]=s*d+c*u,e[3]=s*_+c*g,e}function T(e,t){let o,n=t[0]+t[4]+t[8];if(0<n)o=he(n+1),e[3]=0.5*o,o=0.5/o,e[0]=(t[5]-t[7])*o,e[1]=(t[6]-t[2])*o,e[2]=(t[1]-t[3])*o;else{let n=0;t[4]>t[0]&&(n=1),t[8]>t[3*n+n]&&(n=2);let r=(n+1)%3,i=(n+2)%3;o=he(t[3*n+n]-t[3*r+r]-t[3*i+i]+1),e[n]=0.5*o,o=0.5/o,e[3]=(t[3*r+i]-t[3*i+r])*o,e[r]=(t[3*r+n]+t[3*n+r])*o,e[i]=(t[3*i+n]+t[3*n+i])*o}return e}function O(e,t,o,n){const r=Float32Array.of(...t,...o,...n);return ze(e,T(e,r))}function w(e){return e*ve/180}function P(e){const t=Je.createBuffer();return Je.bindBuffer(Je.ARRAY_BUFFER,t),Je.bufferData(Je.ARRAY_BUFFER,new Float32Array(e),Je.STATIC_DRAW),t}function C(e){const t=Je.createBuffer();return Je.bindBuffer(Je.ELEMENT_ARRAY_BUFFER,t),Je.bufferData(Je.ELEMENT_ARRAY_BUFFER,new Uint16Array(e),Je.STATIC_DRAW),t}function M(e,t){const o=Je.createShader(e);if(Je.shaderSource(o,t),Je.compileShader(o),!Je.getShaderParameter(o,Je.COMPILE_STATUS))throw Je.getShaderInfoLog(o);return o}function D(e,t){const o=Je.createProgram();if(Je.attachShader(o,e),Je.attachShader(o,t),Je.linkProgram(o),!Je.getProgramParameter(o,Je.LINK_STATUS))throw Je.getProgramInfoLog(o);return o}function U(e){return`#version 300 es
  ...
  `}function I(e=0,t=1){return _e(gt()*(t-e+1)+e)}function j(e=0,t=1){return gt()*(t-e)+e}function N(e){return e[I(0,e.length-1)]}function H(e){return new $e({components:[new ot({position:e})]})}function q({position:e,scale:t}){let o=new Nt;return o.components.get(rt).set({material:Xt,color:xt,tag:Gt}),o.components.get(ot).set({position:e,scale:t}),o}function G({position:e,color:t,intensity:o}){return new $e({components:[new ot({position:e}),new vt({color:t,intensity:o})]})}function Y({position:e,scale:t,color:o,is_north_south:n,is_negative:r}){let i=H(e),a=new Nt;a.components.get(rt).set({material:Xt,color:o,tag:Yt}),a.components.get(ot).set({scale:t}),i.add(a);let s=G({position:[n?0:r*At,0,n?r*At:0],color:o,intensity:Rt});return i.add(s),i}function z({position:e,scale:t,neons:o}){let n=H(e),r=new Nt;r.components.get(rt).set({material:Xt,color:xt,tag:Gt}),r.components.get(ot).set({scale:t}),n.add(r);for(let r of o){let e=Y(r);n.add(e)}return n}function W(e){let t=new Nt;return t.components.get(rt).set({material:Vt,color:kt}),t.components.get(ot).set(e),t.add_component(new Mt({radius:0.6,action:[Ce]})),t.add_component(new Ht({speed:[0,0.0001,0]})),t}function K({system:e,position:t}){let o=new Nt;o.components.get(rt).set({material:Xt,color:kt,tag:zt}),o.components.get(ot).set({position:t}),o.add_component(new Mt({radius:1,action:[Pe,e]})),o.add_component(new Ht({speed:[0.0001,0.0002,0.0003]}));let n=new $e({components:[new ot,new mt({color:kt,intensity:Ft})]});return o.add(n),o}function X(){const e=new _t({width:window.innerWidth,height:window.innerHeight,far:126,clear_color:Et});e.buildings=[],e.perspe_matrix=JSON.parse(JSON.stringify(e.projMatrix)),e.setup_ortho_camera(),e.canvas.addEventListener("click",()=>document.body.requestPointerLock()),e.camera.components.get(ot).set({position:[Jt.start[0]*ht,1.75,Jt.start[1]*ht]}),e.camera.remove_component(st);const t=new yt;e.camera.add_component(t),t.set({keyboard_controlled:!0,mouse_controlled:!1,move_speed:5,rotate_speed:0}),e.camera.add_component(new Dt),e.camera.add_component(new Ct),e.remove(e.light);let o=q({position:[0,-0.5,0],scale:[10*(Jt.size[0]*ht),1,10*(Jt.size[1]*ht)]});e.add(o);for(let[t,o,n,r,i]of Jt.buildings){let a=ue(n-t)*ht,s=ue(r-o)*ht,c=t*ht+a/2,m=o*ht+s/2,l=i*ht,d=z({position:[c,l/2,m],scale:[a,l,s],neons:Array(I(2,4)).fill(0).map((e,t,o)=>{const n=N([!0,!1]),r=N([1,-1]),i=l*St/(o.length+0.5);return{position:[n?0:r*(a/2)+0.2*r,l/2-(i+0.5)*(t+1),n?r*(s/2)+0.2*r:0],scale:[n?a*St:0.1,i,n?0.1:s*St],color:xt,is_north_south:n,is_negative:r}})});e.add(d),e.buildings.push([c-a/2,c+a/2,m-s/2,m+s/2])}for(let[t,o,n]of Jt.items)e.add(K({system:Te[t],position:[o*ht,1.75,n*ht]}));return window.game=e,e}function J(e){e.add(W({position:[Jt.end[0]*ht,50*ht/2,Jt.end[1]*ht],scale:[5*ht,200,5*ht]}))}function Z(e){e.stop(),e.destroy(),e.canvas.remove()}function $(){let e=j(Tt,Ot);return t(o(0<e?e+1:e,wt,Pt))}function Q(e,t){switch(t){case Ae:for(let t of e.components.get(rt))switch(t.tag){case Gt:t.material=Kt,t.color=bt;continue;case Yt:t.material=Wt;continue;case zt:t.material=Vt;}break;case Re:for(let t of e.components.get(rt))switch(t.tag){case Yt:{let e=$();t.set({color:e});for(let o of t.entity.parent.iterall(vt))o.set({color:e})}}break;case Fe:e.camera.components.get(yt).set({mouse_controlled:!0,rotate_speed:.5});break;default:}}function ee(e){return[...e].map((e)=>e.codePointAt(0)).reduce((e,t)=>e+t,0)}function te(e){let t=ee(e)%20;return to`
        <div class="g">
    ...
    `}function re(e){return new class extends Ee{before(e){clearInterval(this.interval),e.removeEventListener("click",this.onclick)}after(t){let o=document.createElement("div"),n=e.split("\n")[Symbol.iterator](),r=t.querySelector(".t"),i=()=>{let e=n.next();e.done?clearInterval(this.interval):(o.innerHTML=ne(e.value),r.appendChild(o.firstElementChild))};this.onclick=()=>{this.before(t),this.interval=setInterval(i,100)},this.interval=setInterval(i,1e3),t.addEventListener("click",this.onclick)}render(){return to`
                <div class="m s">
...
<button onclick="dispatch(${Oe});event.stopPropagation()">Run system diagnostic</button>
`,no=`\
...
`;var ro=function*(){for(let e=U.toString().split("\n").slice(7,-2).map((e)=>e.trim()).filter(Boolean),t=0;;)yield e[t++%e.length]}();const io=[new Intl.DateTimeFormat("en",{weekday:"short",month:"short",day:"2-digit",year:"numeric"}),new Intl.DateTimeFormat("en",{hour:"2-digit",minute:"2-digit",second:"2-digit"})];let ao="NW ---- N ---- NE ---- E ---- SE ---- S ---- SW ---- W ---- ",so=ao.length;ao=ao+ao+ao;let co=2*ve/so,mo=18;class lo extends ft{action(){for(let e=0;e<this.from.length;e++)this.object[e]=this.from[e]+this.current_step*(this.to[e]-this.from[e])}pre_start(){super.pre_start(),this.from=u(this.object)}}var _o=Qt(function({game:e,last:t,systems:o}){return new class extends Ee{after(){t===xe&&(setTimeout(()=>new lo({object:e.projMatrix,to:e.perspe_matrix,time:3e3,game:e}).start(),5e3),setTimeout(()=>dispatch(Pe,be),7e3))}render(){return to`
                <div class="m u">
                    ...
                    ${o[Ae]&&ce("br",{align:"end"})}
                </div>
            `}}}),fo=Qt(function({view:e,systems:t}){switch(e){case"intro":return re(oo);case"diag":{let e=ae(t),o=e.pop(),n=["Running analysis\u2026\n",...e,`\n${o}`,`\n<button onclick="dispatch(${we});event.stopPropagation()">Initiate recovery sequence</button>`].join("\n");return re(n)}case"play":return _o();case"outro":return re(no);}});let po=document.styleSheets[0],uo=20,go=new Intl.NumberFormat("en",{style:"percent"});for(let e=0;20>e;e++)po.insertRule(`
        @keyframes n${e} {
